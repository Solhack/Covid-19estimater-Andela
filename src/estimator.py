...
def impactAssess(reportedCases, numberOfDays, hospitalBeds):
    ...
    hospitalBedsLeft = data['totalHospitalBeds'] * .35 \
        - severeCasesByRequestedTime
    severeHospitalBedsLeft = data['totalHospitalBeds'] * .35 \
    ...
    dollarsInFlight = int(impactTime * income * percentage
                          / numberOfDays)
    severeDollarsInFlight = int(impactTimeSevere * income * percentage
                                / numberOfDays)
    ...
    (
        ...
        dollarsInFlight,
        severeDollarsInFlight,
        ) = impactAssess(reportedCases, numberOfDays, hospitalBeds)
